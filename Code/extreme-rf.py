...
class DecisionTree:
    ...
    def _best_split(self, X, y):
        ...
        # -------- CHANGE 1: NORMALIZED RANDOM THRESHOLD --------
        min_v = np.min(values)
        max_v = np.max(values)
        ...
        if max_v - min_v == 0:
            ...
            thresh_norm = np.random.uniform(0.2, 0.5)
            thresh = min_v + thresh_norm * (max_v - min_v)
        # ------------------------------------------------------
