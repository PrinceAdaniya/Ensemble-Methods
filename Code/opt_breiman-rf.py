...
def run_experiment(dataset_name):
    ...
    plt.legend()
    plt.savefig(f"{GRAPH_DIR}/OPT_breiman-rf_{dataset_name}_AE.png")
    plt.close()
    ...
    plt.legend()
    plt.savefig(f"{GRAPH_DIR}/OPT_breiman-rf_{dataset_name}_SC.png")
    plt.close()
